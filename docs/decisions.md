# Decisions
## Can two or more mechanics worsk in the same repair?
### Assumption:
...
## The customer approve or reject the full repair, or can they approve individual services?
### Assumption:
...
## The system need to record the current owner of a bike?
### Assumption:
